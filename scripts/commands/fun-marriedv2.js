...
async function makeImage({ one, two }) {
    ...
    let pathImg = __root + `/batman${two}_${one}.png`;
    ...
    batgiam_img.composite(circleOne.resize(100, 100), 100, 90).composite(circleTwo.resize(100, 100), 190, 40);
